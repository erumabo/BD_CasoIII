CREATE TABLE cliente.Cliente ( 
  "Cedula" VARCHAR(10) CONSTRAINT NOT_NULL01 NOT NULL , 
...
CREATE TABLE prenda.Color ( 
  "idColor" NUMERIC(2) CONSTRAINT NOT_NULL02 NOT NULL , 
  "descrip" VARCHAR(40) CONSTRAINT NOT_NULL03 NOT NULL , CONSTRAINT "COLOR_PK" PRIMARY KEY ( "idColor" ) );

CREATE TABLE prenda.Conjunto ( 
  "idConjunto" NUMERIC(4) CONSTRAINT NOT_NULL04 NOT NULL , 
  "Nombre" VARCHAR(40) CONSTRAINT NOT_NULL05 NOT NULL , CONSTRAINT "Conjunto_PK" PRIMARY KEY ( "idConjunto" ) );

CREATE TABLE orden.Estado ( 
  "idEstado" NUMERIC(1) CONSTRAINT NOT_NULL06 NOT NULL , 
  "Estado" VARCHAR(12) NULL , CONSTRAINT "Estado_PK" PRIMARY KEY ( "idEstado" ) );

CREATE TABLE prenda.Estilo ( 
  "idEstilo" NUMERIC(2) CONSTRAINT NOT_NULL07  NOT NULL , 
  "idColor" NUMERIC(2) CONSTRAINT NOT_NULL08  NOT NULL , 
  "descrip" VARCHAR(140) NULL , CONSTRAINT "Estilo_PK" PRIMARY KEY ( "idEstilo" ) );

CREATE TABLE proveedor.Extranjero ( 
  "idProveedor" NUMERIC(2) CONSTRAINT NOT_NULL09  NOT NULL , 
...
CREATE TABLE receta.Ingrediente ( 
  "idMateria" NUMERIC(4) CONSTRAINT NOT_NULL10  NOT NULL , 
  "idReceta" NUMERIC(4) CONSTRAINT NOT_NULL11  NOT NULL , 
  "Cantidad" NUMERIC(4) NULL , CONSTRAINT "Ingrediente_PK" PRIMARY KEY ( "idMateria", "idReceta" ) );

CREATE TABLE receta.MateriaPrima ( 
  "idMaterial" NUMERIC(4) CONSTRAINT NOT_NULL12  NOT NULL , 
...
CREATE TABLE proveedor.MateriaXProveedor ( 
  "idMateria" NUMERIC(4) CONSTRAINT NOT_NULL13  NOT NULL , 
  "idProveedor" NUMERIC(2) CONSTRAINT NOT_NULL14  NOT NULL , 
...
CREATE TABLE proveedor.Nacional ( 
  "idProveedor" NUMERIC(2) CONSTRAINT NOT_NULL15  NOT NULL , 
...
CREATE TABLE orden.OrdenProduccion ( 
  "idOrden" NUMERIC(7) CONSTRAINT NOT_NULL016 NOT NULL , 
...
CREATE TABLE prenda.Prenda ( 
  "idPrenda" NUMERIC(4) CONSTRAINT NOT_NULL17  NOT NULL , 
...
CREATE TABLE prenda.PrendaXConjunto ( 
  "idConjunto" NUMERIC(2) CONSTRAINT NOT_NULL18 NOT NULL , 
  "idPrenda" NUMERIC(4) CONSTRAINT NOT_NULL19 NOT NULL , CONSTRAINT "PrendaXConjunto_PK" PRIMARY KEY ( "idConjunto", "idPrenda" ) );

CREATE TABLE orden.PrendaXOrden ( 
  "idPrenda" NUMERIC(4) CONSTRAINT NOT_NULL20 NOT NULL , 
  "idSolicitud" NUMERIC(6) CONSTRAINT NOT_NULL21 NOT NULL , 
  "Cantidad" NUMERIC(6) NULL , CONSTRAINT "PrendaXOrden_PK" PRIMARY KEY ( "idPrenda", "idSolicitud" ) );

CREATE TABLE proveedor.Proveedor (
  "idProveedor" NUMERIC(2) CONSTRAINT NOT_NULL22 NOT NULL , 
  "Direccion" VARCHAR(120) NULL , 
  "nombre" VARCHAR(15) NULL , CONSTRAINT "Proveedor_PK" PRIMARY KEY ( "idProveedor" ) );

CREATE TABLE receta.Receta ( 
  "idPrenda" NUMERIC(4) NULL , 
  "idReceta" NUMERIC(4) CONSTRAINT NOT_NULL23 NOT NULL , 
  "Descripcion" VARCHAR(120) NULL , CONSTRAINT "Receta_PK" PRIMARY KEY ( "idReceta" ) );

CREATE TABLE orden.Solicitud ( 
  "idSolicitud" NUMERIC(6) CONSTRAINT NOT_NULL24 NOT NULL , 
  "idCliente" VARCHAR(10) CONSTRAINT NOT_NULL25  NOT NULL , 
  "FechaProduccion" DATE NULL , 
  "FechaRegistro" DATE CONSTRAINT NOT_NULL26 NOT NULL , CONSTRAINT "Solicitud_PK" PRIMARY KEY ( "idSolicitud" ) );

CREATE TABLE cliente.Telefono ( 
  "idCliente" VARCHAR(10) CONSTRAINT NOT_NULL27  NOT NULL , 
  "Telefono" NUMERIC(8) CONSTRAINT NOT_NULL28 NOT NULL , 
...
CREATE TABLE proveedor.TelefonoProveedor ( 
  "idProveedor" NUMERIC(2) CONSTRAINT NOT_NULL29 NOT NULL , 
  "Telefono" NUMERIC(8) CONSTRAINT NOT_NULL30 NOT NULL , 
...
CREATE TABLE receta.UnidadMedida ( 
  "idUnidad" NUMERIC(4) CONSTRAINT NOT_NULL31 NOT NULL , 
  "Nombre" VARCHAR(20) NULL , 
